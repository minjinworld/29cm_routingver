        ...
        <div className="top">
          ...
          <div className="user_box">
            <div className="user_nav mypage">
              ...
              <span className="user_nav_list">my page</span>
            </div>
            <div className="user_nav mylike">
              ...
              <span className="user_nav_list">my like</span>
            </div>
            <div className="user_nav cart">
              ...
              <span className="user_nav_list">shopping bag</span>
            </div>
            <div className="user_nav login">
              ...
              <span className="user_nav_list">login</span>
            </div>
          </div>
        </div>
      ...
      <footer className="footer_area">
        <div className="footer_content footer_top">
          ...
          <div className="service_hours">
            운영시간 : 펑일 09:00 ~ 18:00 (점심시간 12:00 ~ 13:00 제외)
          </div>
        </div>
